...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\filecache on
     Windows, /home/user/dev/filecache on Linux) in a file named
     filecache@edwardbenson.com and copy that file to
